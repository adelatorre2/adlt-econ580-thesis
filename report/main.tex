...
% Suppress the `note` field in printed bibliography entries (Zotero research
% memos leaked into the note field of several items; keep the .bib untouched).
...
% \printtodos  % suppressed for final submission
